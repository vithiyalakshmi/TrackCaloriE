	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_main8);
		 Bundle b = getIntent().getExtras();
	  		...
	  		Toast.makeText(MainActivity8.this,bmi1,Toast.LENGTH_SHORT).show();
	  		...
	  		if(str.equals("true")) 
	  		{
	  	  		Toast.makeText(MainActivity8.this,"underweight",Toast.LENGTH_SHORT).show();
	  		...
	  		{
	  			Toast.makeText(MainActivity8.this,"normal",Toast.LENGTH_SHORT).show();
	  			et1.setText("fruit salad");
	  		...
	  		if(str3.equals("true"))
	  		{
	  			Toast.makeText(MainActivity8.this,"overweight",Toast.LENGTH_SHORT).show();
	  			et1.setText("fruit salad");
